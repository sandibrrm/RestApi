...
#[derive(Debug)]
pub struct RestApiProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RestApiProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RestApi processing");
    
    let mut processor = RestApiProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RestApiProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RestApiProcessor::new(false);
